...
const Faqs = () => {
  ...
  <p className='bi bi-arrow-right  text-dark'>The main is to find the faculty jobs and for admin to view faculty detail easily</p>
...
<div className="box" style={{ backgroundColor: "rgb(252, 255, 196)" }}>
  ...
  <p className='bi bi-arrow-right  text-dark'>Yes, everyone who is seeking faculty jobs can log in easily. However, posting jobs can only be done by the superadmin of the institute</p>
...
<div className="box" style={{ backgroundColor: "rgb(422, 155, 156)" }}>
  ...
  <p className='bi bi-arrow-right  text-dark'>Superadmin can easily post and view details of faculty who are a part of their institute</p>
 
</div>
<div className="box" style={{ backgroundColor: "rgb(402, 175, 116)" }}>
  <strong>
   <div >
   <h3><em className='bi bi-pen-fill  text-dark'>Are there any specific qualifications required to register on the website?
</em></h3>
   </div>
  </strong>
  <p className='bi bi-arrow-right  text-dark'>Yes, everyone who is seeking faculty jobs can log in easily. However, posting jobs can only be done by the superadmin of the institute</p>
...
<div className="box" style={{ backgroundColor: "rgb(362, 100, 200)" }}>
  <strong>
   <div >
   <h3><em className='bi bi-pen-fill  text-dark'>What features does the website offer to job seekers?
</em></h3>
   </div>
  </strong>
  <p className='bi bi-arrow-right text-dark'>No, there are no specific qualifications required to register on the website. It is open to individuals from various educational backgrounds and career levels seeking faculty positions.
